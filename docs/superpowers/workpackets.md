...
| WP14 Console tool metadata | `wp14-console-tool-metadata` | D | — | precondition: console listed on Glama? | **CLAIMED 2026-08-06** (`wp14-console-tool-metadata`; [#13](https://github.com/Wuesteon/lean-memory/issues/13)) |
